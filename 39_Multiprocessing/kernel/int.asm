...
extern isr_noerr_exception, isr_err_exception, isr_default_int, isr_irq0, isr_irq1, isr_irq5, isr_irq12, handle_syscall, isr_debugcall, isr_schedule, isr_spurious
global isr_stub_table, isr_default_stub, isr_irq0_stub, isr_irq1_stub, isr_irq5_stub, isr_irq12_stub, isr_syscall_stub, isr_debugcall_stub, isr_schedule_stub, isr_spurious_stub
...
%macro APIC_EOI 0
    ; Write a DWORD 0 to the EOI register
    push rax
    mov rax, 0xfee000b0
    mov dword [rax], 0
    pop rax
